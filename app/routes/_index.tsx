              ...
              <div className="pt-5 text-white">
                ...
                <div className="flex gap-2 pt-4 justify-center 2xl:justify-start">
                  ...
                  <Link to={"https://www.instagram.com/charlsdaveerana/"} target="_blank">
                    <img className="h-6 mr-1 cursor-pointer hover:border-2 hover:border-black" src="/app/img/instagram.svg" alt="person" />
                  </Link>
                  <Link to={"https://www.tiktok.com/@charlsdaveerana"} target="_blank">
                    <img className="h-6 mr-1 cursor-pointer hover:border-2 hover:border-black" src="/app/img/tiktok.svg" alt="person" />
                  </Link>
