    ...
    const projects = [
        {
            ...
            techStack: ["React", "Remix", "Supabase", "Tailwind CSS", "Ant Design", "Vite", "NPM", "GitHub"],
        ...
        },
        {
            ...
            features: [
                ...
                "Mortality and reduction history reports",
                "Daily metrics and average weight monitoring",
                "Account and settings management"
            ],
            techStack: ["React", "Supabase", "Tailwind CSS", "Ant Design", "Vite", "NPM", "GitHub"],
            image: "poultry4.png",
            images: ["poultry1.jpg", "poultry2.jpg", "poultry3.jpg", "poultry4.png"],
            link: "#",
            type: "solo"
        },
        {
        ...
        <div className="bg-white rounded-xl shadow-sm transition-colors duration-200 dark:bg-gray-900">
            ...
            <div className="grid grid-cols-1 gap-8">
                {projects.map((project, index) => (
                    <div
                        key={index}
                        className="group bg-white rounded-lg border border-gray-200 hover:border-blue-300 transition-all duration-200 overflow-hidden hover:shadow-md dark:border-gray-800 dark:bg-gray-800 dark:hover:border-blue-500"
                    >
                        {/* Project Header */}
                            ...
                            <div className="flex items-start justify-between mb-3">
                                <div className="flex-1">
                                    <div className="flex items-center gap-2 mb-1">
                                        <h3 className="text-lg font-semibold text-gray-900 group-hover:text-blue-600 transition-colors dark:text-gray-100">
                                            {project.title}
                                        </h3>
                                        {project.type === "team" && (
                                            <span className="text-xs font-medium text-gray-500 bg-gray-100 px-2 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300">
                                                Team Project
                                            </span>
                                        )}
                                    </div>
                                    <div className="flex items-center text-sm text-gray-500 mb-2 dark:text-gray-400">
                                        <span className="bg-gray-100 px-2 py-0.5 rounded mr-2 dark:bg-gray-700">
                                            {project.year}
                                        </span>
                        ...
                        <div className="space-y-3">
                            <div
                                className="relative overflow-hidden bg-gray-50 cursor-pointer dark:bg-gray-900"
                                ...
                                <div className="grid grid-cols-3 gap-3 px-5">
                                    {project.images.map((imageName, imageIndex) => (
                                        <button
                                            ...
                                            onClick={() => setFullscreenImage(`./img/${imageName}`)}
                                        >
                                            <img
                        ...
                        <div className="p-5 pt-4">
                            <h4 className="text-sm font-medium text-gray-900 mb-2 dark:text-gray-100">Key Features</h4>
                            <ul className="space-y-1 mb-4">
                                ...
                                {project.features.length > 3 && (
                                    <li className="text-xs text-gray-500 pl-5 dark:text-gray-400">
                        ...
                        <div className="p-5 pt-0">
                            <div className="flex items-center justify-between mb-2">
                                <h4 className="text-sm font-medium text-gray-900 dark:text-gray-100">Technology Stack</h4>
                            </div>
                            <div className="flex flex-wrap gap-2">
                                {project.techStack.map((tech, i) => {
                                    ...
                                    return (
                                        <span
                                            key={i}
                                            className="inline-flex items-center gap-1.5 px-3 py-1 bg-gray-100 text-gray-700 text-xs rounded-full border border-gray-200 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300"
                                        >
                                            {iconPath && (
                                                <img
                                                    src={iconPath}
                        ...
                        {/* Action Button */}
                        <div className="p-5 pt-4 border-t border-gray-100 dark:border-gray-700">
            ...
            <div className="mt-12 pt-8 border-t border-gray-100 dark:border-gray-800">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div className="text-center">
                        <div className="text-2xl font-bold text-gray-900 dark:text-gray-100">2020-2026</div>
                        <div className="text-sm text-gray-600 mt-1 dark:text-gray-400">Project Timeline</div>
                    </div>
                </div>
            </div>
            ...
            {confidentialModalOpen && (
                ...
                >
                    <div
                        className="bg-white rounded-xl shadow-2xl max-w-md w-full p-6 relative dark:bg-gray-900"
                        onClick={(e) => e.stopPropagation()}
                    >
                        <button
                            onClick={() => setConfidentialModalOpen(false)}
                        ...
                        <div className="mb-6">
                            <p className="text-gray-700 mb-3 dark:text-gray-300">
                                This project is <span className="font-semibold text-gray-900 dark:text-gray-100">confidential and exclusive</span> to the company.
                            </p>
                        ...
                        <div className="bg-gray-50 rounded-lg p-4 mb-4 dark:bg-gray-800">
                            <p className="text-sm text-gray-600 dark:text-gray-400">
                                <span className="font-medium text-gray-900 dark:text-gray-100">Note:</span> If you are an authorized representative of the company and need access to this project, please contact the project administrator directly.
                            </p>
                        </div>
                        <button
                            onClick={() => setConfidentialModalOpen(false)}
