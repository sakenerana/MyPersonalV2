    ...
    return (
        <div>
                ...
                <div className="flex flex-wrap gap-2 mt-1">
                    <Link to={"https://react.dev/"} target="_blank">
                        <div className="flex cursor-pointer bg-black pr-3 pl-3 pt-1 pb-1 rounded-2xl text-[14px] hover:border hover:border-white">
                            <img className="h-5 pr-2" src="/app/img/react.svg" alt="react" />
                            React
                        </div>
                    </Link>
            ...
            <div className="col-span-full">
                ...
                <h1 className="mt-2"><b>User Interface</b></h1>
                <img className="h-fit mt-2 w-100vw hover:border-2 hover:border-black" src="/app/img/clevermasters.png" alt="clevermasters" />
                <div className="border-t border-gray-200 my-4"></div>
            </div>
